...
interface MobileBottomNavbarProps {
  activeTab: 'news' | 'shorts' | 'haac' | 'signaler' | 'academy' | 'about' | 'contact' | 'media-dashboard' | 'admin-dashboard' | 'profile' | 'privacy' | 'terms' | 'image-check';
...
export default function MobileBottomNavbar({
  ...
  const getActiveSlot = () => {
    ...
    if (activeTab === 'haac' || activeTab === 'signaler' || activeTab === 'image-check') return 'verify';
