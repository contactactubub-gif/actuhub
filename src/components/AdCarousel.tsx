...
export const AdCarousel: React.FC<AdCarouselProps> = ({
  ...
  // If placementFilter is specified, only display ads strictly matching this placement
  const displayAds = placementFilter ? activeAds : (activeAds.length > 0 ? activeAds : DEFAULT_CNIN_BENIN_ADS);
